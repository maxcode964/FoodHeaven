...
<html lang="en" dir="ltr">
  ...
  <body style="background-image:url('../../Login Page/images/background.jpg');">
    <br>
    ...
    <div class="row" style="margin-left:15px;margin-right:15px;">
      <div class="col-md-3">
        <h3  style="color:#ffbb55">Mark Attendance</h3>
        <form action="" method="post">
          <div class="form-group">
            <label style="color:#ffbb55">Enter ID No:</label>
            <input type="text" class="form-control" name="id" placeholder="Enter ID No.">
          </div>
          <div class="form-group">
            <label style="color:#ffbb55">Select Type:</label>
          ...
          <div class="form-group">
            <label style="color:#ffbb55">Attendance:</label>
      ...
      <div class="col-md-2">
        <h3 style="color:#ffbb55"   >Quick Actions</h3> <br>
