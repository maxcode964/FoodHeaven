...
<body>
	<nav class="navbar navbar-expand-lg" style="background-color:#ffbb55;background: rgba(217, 217, 217, 0.25);
}">
		<div class="container-fluid">
			<a class="navbar-brand" href="../index.html"><h3 style="color:#ffbb55;">FoodHaven</h3></a>
